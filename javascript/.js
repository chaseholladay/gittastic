// GIFTASTIC! 
var topics = ["Fly Fishing", "Deep Sea Fishing", "Spear Fishing", "Noodling"];
...
$("#buttonArea").on("click", ".btn", function(){
  		...
  		var queryURL = "https://api.giphy.com/v1/gifs/random?q=" + thing + "&api_key=3tkP7LMRZi6HwVUhCY1wZmEzU1kO7V7Z";
